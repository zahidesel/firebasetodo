...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://todolist-327da-default-rtdb.europe-west1.firebasedatabase.app/items/.json')
  ...
  const deleteTodo = (id) => {
    fetch(`https://todolist-327da-default-rtdb.europe-west1.firebasedatabase.app/items/${id}.json`,
    {
      method: 'DELETE',
    })
    .then(response => fetchItems())
